// Pre-optimization renderers retained only as independent pixel-test oracles.
use super::*;

impl GbaEmulator {
    pub(super) fn sample_obj_pixels(
        &self,
        line: u32,
        dispcnt: u16,
        x: u32,
    ...
    pub(super) fn sample_objwin_hit(
        &self,
        line: u32,
        dispcnt: u16,
        x: u32,
    ...
    pub(super) fn sample_text_bg_color(
        &self,
        line: u32,
        layer: &TextBgLayer,
        x: u32,
